...
# palindroom() schrijven. Deze functie moet True teruggeven als het woord een palindroom is, en False als het geen
# palindroom is. Je kan de functie 'palindroom_test()' gebruiken om te testen of je programma werkt. Hiervoor geef je
# het woord TEST in als input.
...
def palindroom_test():
    ...
    print("De functie palindroom() werkt goed!")
    return
